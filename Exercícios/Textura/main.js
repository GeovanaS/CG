...
function main() {
  ...
  webglLessonsUI.setupSlider("#x",      {slide: updateTextureX, max: gl.canvas.width});
  webglLessonsUI.setupSlider("#y",      {slide: updateTextureY, max: gl.canvas.height});

  function updateTextureX(event,ui){
     var newTextX = ui.value;
     textureX = newTextX/100;
     setTexcoords(gl,textureX,1);
  }

  function updateTextureY(event,ui){
      var newTextY= ui.value;
      textureY = newTextY/100;
      setTexcoords(gl,textureY,1);
  }
